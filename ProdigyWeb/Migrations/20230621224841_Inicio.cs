        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NomeTitular = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    TipoCartao = table.Column<string>(type: "text", nullable: true),
                    CpfTitular = table.Column<string>(type: "character varying(14)", maxLength: 14, nullable: true),
                    CnpjTitular = table.Column<string>(type: "character varying(18)", maxLength: 18, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ConfigId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    PorcentagemLucro = table.Column<string>(type: "text", nullable: true),
                    TaxaCredito = table.Column<string>(type: "text", nullable: true),
                    TaxaDebito = table.Column<string>(type: "text", nullable: true),
                    TaxaParcela = table.Column<string>(type: "text", nullable: true),
                    PorcentagemDesconto = table.Column<string>(type: "text", nullable: true),
                    NfEletronica = table.Column<string>(type: "text", nullable: true),
                    UsuarioId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataFundacao = table.Column<string>(type: "text", nullable: true),
                    CertificadoNF = table.Column<string>(type: "text", nullable: true),
                    Rua = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Numero = table.Column<int>(type: "integer", nullable: false),
                    Complemento = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    Bairro = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ModuloId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    NomeSistema = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SCategoriaProdutos_Usuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuarios",
                        principalColumn: "UsuarioId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cpf = table.Column<string>(type: "character varying(14)", maxLength: 14, nullable: true),
                    DataRegistro = table.Column<string>(type: "text", nullable: true),
                    DataNacimento = table.Column<string>(type: "text", nullable: true),
                    Sexo = table.Column<string>(type: "text", nullable: true),
                    Rua = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Telefone = table.Column<string>(type: "text", nullable: true),
                    Cnpj = table.Column<string>(type: "character varying(18)", maxLength: 18, nullable: true),
                    CpfRepresentante = table.Column<string>(type: "character varying(18)", maxLength: 18, nullable: true),
                    RgEstadual = table.Column<string>(type: "text", nullable: true),
                    RgMunicipal = table.Column<string>(type: "text", nullable: true),
                    DataFundacao = table.Column<string>(type: "text", nullable: true),
                    NomeRepresentante = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    DataRegistro = table.Column<string>(type: "text", nullable: true),
                    Rua = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    Numero = table.Column<string>(type: "text", nullable: true),
                    Complemento = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Imagem = table.Column<string>(type: "text", nullable: true),
                    DataNascimento = table.Column<string>(type: "text", nullable: true),
                    EstadoCivil = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    Sexo = table.Column<string>(type: "character varying(25)", maxLength: 25, nullable: true),
                    Cpf = table.Column<string>(type: "character varying(14)", maxLength: 14, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SFuncionarios_Usuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuarios",
                        principalColumn: "UsuarioId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Imagem = table.Column<string>(type: "text", nullable: true),
                    ValorInicial = table.Column<string>(type: "text", nullable: false),
                    ValorFinal = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SCategoriaProdutos_UsuarioId",
                table: "SCategoriaProdutos",
                column: "UsuarioId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SFuncionarios_UsuarioId",
                table: "SFuncionarios",
                column: "UsuarioId");
